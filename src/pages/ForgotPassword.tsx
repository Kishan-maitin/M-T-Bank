...
import {
  ...
  verifyOTP,
  forgotPassword,
} from "../apis/commonApiCalls/authenticationApi";
...
const ForgotPassword: React.FC = () => {
  ...
  const [executeForgotPassword, isResettingPassword] =
    useApiCall(forgotPassword);
          ...
          <form onSubmit={handleSendOTP} className="space-y-4">
            <div>
              ...
              <div className="mt-1 relative" style={{ height: "auto" }}>
                {" "}
                {/* Adjusted height to auto for flex layout of CustomPhoneInput */}
                <CustomPhoneInput
                  value={phoneNumber}
