        ...
        <div className="space-y-6 text-foreground">
          <div className="space-y-2">
            ...
            <p className="leading-relaxed text-sm">
              ...
              the following Terms of Use ("TOU"). BondBridge reserves the right
              to update and modify the TOU at any time without notice. The most
              ...
              pages. When we make updates to the TOU, BondBridge will update the
              date at the top of this page. By using the website after a new
              version of the TOU has been posted, you agree to the terms of such
              new version.
            </p>
          </div>
          ...
          <div className="space-y-2">
            ...
            <p className="leading-relaxed text-sm">
              Through its network of Web properties, BondBridge provides you
              with access to a variety of resources, including applications,
          ...
          <div className="space-y-2">
            ...
            <p className="leading-relaxed text-sm">
              ...
              the exclusive property of BondBridge or its content suppliers and
              is protected by applicable intellectual property laws. All rights
              not expressly granted are reserved and retained by BondBridge or
              its licensors.
            </p>
          </div>
          ...
          <div className="space-y-2">
            ...
            <p className="leading-relaxed text-sm">
              ...
              BondBridge and/or its suppliers. Use of the Software is governed
              by the end user license agreement. Unauthorized reproduction or
          ...
          <div className="space-y-2">
            ...
            <p className="leading-relaxed text-sm">
              ...
              regulations. Manufacturer is BondBridge Corporation, One
              BondBridge Way, Redmond, WA 98052-6399.
            </p>
          </div>
          ...
          <div className="space-y-2">
            ...
            <p className="leading-relaxed text-sm">
              These permissions do not include website design or layout
              elements, which may not be copied or imitated without express
              permission.
            </p>
          </div>
          ...
          <div className="space-y-2">
            ...
            <p className="leading-relaxed text-sm">
              Software and tools are provided "as is" without warranties except
              as specified in the license agreement. BondBridge disclaims all
          ...
          <div className="space-y-2">
            ...
            <p className="leading-relaxed text-sm">
              The Services may include communication tools. You agree to use
              them only to post and share appropriate, lawful content. Examples
              of prohibited actions include spamming, harassment, uploading
              viruses, and violating others' rights.
            </p>
            ...
            <p className="leading-relaxed text-sm">
              ...
              and is not responsible for content shared by users. Use caution
          ...
          <div className="space-y-2">
            ...
            <p className="leading-relaxed text-sm">
              ...
              training other AI systems. BondBridge monitors inputs and outputs
              to prevent abuse. Users are responsible for legal compliance and
          ...
          <div className="space-y-2">
            ...
            <p className="leading-relaxed text-sm">
              By submitting content, you grant BondBridge the rights to use it
              in connection with its Services. No compensation is provided. You
              must own or have permission to share submitted content, including
              images.
            </p>
          </div>
          ...
          <div className="space-y-2">
            ...
            <p className="leading-relaxed text-sm">
              ...
              policy prevents disputes over similar ideas developed by
              BondBridge.
            </p>
          </div>
        </div>
