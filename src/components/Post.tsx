...
export function Post({
  ...
  return (
    <>
      <Card
        className="rounded-none border-x-0 border-t-0 shadow-none mb-4 "
        data-post-id={feedId}
      >
        ...
        <div className="flex items-center justify-between p-4 pb-2">
          ...
          >
            <Avatar>
              <AvatarImage
                src={isAnonymous ? "/profile/anonymous.png" : avatar}
                alt={isAnonymous ? "Anonymous" : user}
              />
              <AvatarFallback>
                {isAnonymous ? "A" : user?.charAt(0)}
              </AvatarFallback>
            </Avatar>
            <div>
