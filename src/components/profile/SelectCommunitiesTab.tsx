...
const SelectCommunitiesTab: React.FC = () => {
  ...
  const { communitiesSelected } = useAppSelector(
    ...
    return (
      <div className="h-[45vh]">
        <h1 className="text-3xl font-medium mb-1 text-foreground">
          Let's Join Exciting Communities
        </h1>
        ...
        {communities.map((community) => (
          <div
            ...
            className={`relative rounded-xl cursor-pointer transition-all ${
              isCommunitySelected(community._id) ? "bg-accent" : "bg-muted"
            }`}
          ...
          >
            ...
            <div className="h-16 w-full rounded-t-xl overflow-hidden fill-accent">
              <img
                src={
                  community.backgroundImage || "/profile/community/commbg.png"
                }
                alt=""
            ...
            <div className="absolute left-1/2 transform -translate-x-1/2 -translate-y-1/2">
              <div className="w-16 h-16 rounded-full border-4 border-background overflow-hidden">
                <img
                  src={
                    community.profilePicture || "/profile/default-avatar.png"
                  }
                  alt=""
                  className="w-full h-full object-cover"
                />
      ...
      {communitiesSelected.length > 0 && (
        <div className="mt-6 text-center">
          <p className="text-foreground font-medium">
            You've selected {communitiesSelected.length}{" "}
