        ...
        >
          ...
          >
            {profilePhoto ? (
              ...
              <div
                className={`w-full h-full rounded-full bg-muted flex flex-col items-center justify-center border-2 ${isDragging ? "border-primary bg-primary/10" : "border-dashed border-input"}`}
              >
                <svg
                ...
                {isDragging && (
                  <p className="text-xs text-primary mt-2">Drop image here</p>
                )}
              </div>
            )}
          </div>
