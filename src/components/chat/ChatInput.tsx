...
export const ChatInput = forwardRef<ChatInputRef, ChatInputProps>(
  (
    ...
    const [wasListeningBeforeAudio, setWasListeningBeforeAudio] =
      useState(false);
      ...
      return () => {
        if (recognition && recognitionActiveRef.current) {
          try {
            ...
            console.error(
              "Error stopping speech recognition on unmount:",
              error
            );
          }
        }
          ...
          <Input
            ...
            placeholder={
              isListening && !isAudioPlaying
                ? "Listening..."
                : isAudioPlaying && wasListeningBeforeAudio
                  ? "Audio playing..."
                  : placeholder
            }
            disabled={disabled}
