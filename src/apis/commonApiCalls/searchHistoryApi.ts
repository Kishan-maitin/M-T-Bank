...
export const addToSearchHistory = async (
  ...
  const response = await apiClient.post<AddSearchHistoryResponse>(
    "/add-recent-search",
...
export const removeFromSearchHistory = async (
  userId: string
): Promise<RemoveSearchHistoryResponse> => {
  const response = await apiClient.post<RemoveSearchHistoryResponse>(
...
export const clearSearchHistory =
  async (): Promise<ClearSearchHistoryResponse> => {
    const response = await apiClient.delete<ClearSearchHistoryResponse>(
